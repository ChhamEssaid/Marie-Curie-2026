# STRAT-TRACE v9.11 — notas de trabajo para el envío

Actualización: **8 de septiembre de 2026, Europe/Madrid**. Estas notas conservan los antecedentes científicos de v9.7/v9.9 e incorporan la actualización v9.10 al final. La revisión v9.11 añade una presentación más sobria y ajustes editoriales; para los próximos pasos prevalece CURRENT_STATE. Documento de trabajo separado de la propuesta; no forma parte de Part B1 ni del PDF de candidatura. Consultar [CURRENT_STATE](CURRENT_STATE.md) para el diseño vigente y [README](README.md) para el registro final de comprobaciones de esta entrega.
...
Estas cuatro series tienen valores numéricos, intervalos positivos y unidades declaradas de Bq m⁻³. Durante 1986–2005 aparecen 21 nombres distintos; Berlin, Braunschweig y Risoe tienen registros en cada año. No describir esos 21 nombres como una red simultánea o continua. La auditoría actualizada de v9.9 documenta los recuentos con año del punto medio UTC: consultar el informe incluido para evitar mezclar asignaciones temporales de inventarios previos.
...
## Actualización v9.9 — mentoría y carrera

Zhuyun Ye sigue como supervisora principal. El investigador identifica a Jesper Heile Christensen como mentor complementario; se incorpora su participación en desarrollo DEHM, sensibilidades, interpretación y asesoramiento de la componente del modelo en la futura propuesta. AU verifica públicamente su cargo de Senior Researcher y contribución al desarrollo de DEHM. Silver et al. (2016) demuestra experiencia en asimilación química; no acredita por sí solo especialización en todos los métodos de inferencia de STRAT-TRACE.

La preparación de una propuesta posterior sobre ⁷Be por tamaños se integra en el desarrollo de carrera y WP5 para M24. Se concreta el concepto, las colaboraciones y el presupuesto. NERD de Novo Nordisk es una vía posible si las reglas de la convocatoria aplicable lo permiten; no se promete financiación ni una futura convocatoria concreta. Las nuevas observaciones pertenecen al proyecto posterior financiado. No atribuir compromisos de espacio, instrumentos o personal a instituciones externas a partir de correspondencia exploratoria.

La propuesta ahora cuantifica más de 54.000 registros en aire de 83 series por nombre durante 2009–2024, tras controles iniciales. La auditoría conservadora mantiene el mismo orden de magnitud. Los datos CTBTO no se han recibido todavía y no se suman al inventario europeo. Consultar AUDITORIA_COBERTURA_BE7.md para el criterio vigente.

La edición v9.9 fue archivada previamente en GitHub. La nueva entrega vigente es v9.11; consultar CURRENT_STATE para el repositorio y la carpeta actuales. No se ha enviado correo. El borrador de Gmail anterior no se pudo localizar; no se modificaron otros mensajes.


## Actualización v9.10 — cuatro mejoras, legibilidad y cobertura conjunta
...
Las 43 series europeas con aire y deposición están corroboradas por 42 nombres en el CSV combinado y Brocken en el original DWD. No queda pendiente demostrar que existe una base conjunta; quedan el control metrológico, segmentos de emplazamiento/método y emparejamiento de ventanas. Consultar la auditoría actualizada para fuentes y criterios. Las incertidumbres y límites de detección presentes en los originales deben conservarse; su ausencia en un CSV compilado no implica ausencia de esa información en la colección.

El recuento nominal de 87 series de aire y el de 83 con unidad explícita corresponden a filtros distintos. Se conserva la formulación robusta de más de 54.000 registros de 83 series en Part B1. El investigador confirma la resolución diaria esperada de CTBTO y estima aproximadamente 30 solapamientos con el archivo europeo; se comprobarán tras la entrega. No sumar la red esperada como recibida ni convertirla en cobertura de deposición.
...
## Actualización v9.11 — candidata final
...
La cabecera y los pies no contienen «Part B1», y la apertura no contiene «European Postdoctoral Fellowship». Esta simplificación visible no altera la modalidad de candidatura ni el contenido de las secciones MSCA. Los archivos conservan un nombre simple con número de versión; «candidata final» se utiliza en el registro de trabajo.

Se ha generado y revisado un PDF de diez páginas con todas las fuentes incrustadas y números de página correctos. El Word mantiene los márgenes y la tipografía del cuerpo, las diez tablas y la ecuación nativa. El paquete está preparado para el archivo GitHub habitual; la comprobación final de la copia del portal sigue correspondiendo al envío. No se ha enviado correo ni presentado la candidatura.
